...
namespace EntityFrameWork.Migrations
{
    ...
    [Migration("20210820180910_DailyAndMonthlyTable")]
    partial class DailyAndMonthlyTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EntityFrameWork.Domain.BillInventry", b =>
                {
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("BillInventry");
                });
            ...
            modelBuilder.Entity("EntityFrameWork.Domain.DailyTable", b =>
                {
                    b.HasBaseType("EntityFrameWork.Domain.BillInventry");

                    b.HasDiscriminator().HasValue("DailyTable");
                });
            ...
            modelBuilder.Entity("EntityFrameWork.Domain.MontlyTable", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("MontlyTable");
                });
